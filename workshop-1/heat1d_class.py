...
# heat1d_class.py
# This version refactors the script into classes, demonstrating the
# principles of encapsulation from class-1.md and the basic class
# syntax from class-2.md. The data (Grid) and logic (Solver) are
# now bundled into coherent, reusable objects.
